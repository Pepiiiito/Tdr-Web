            ...
            <div className="container mx-auto px-6">
                ...
                >
                    <SectionHeader
                        label="Comunicació"
                        title="Contacta'ns"
                        subtitle="Tens una idea, una pregunta o vols col·laborar? Escriu-nos — solem respondre en 24-48 h."
                        centered={true}
                    />
                    ...
                    <div className="mt-24 grid md:grid-cols-2 gap-16">
                        ...
                        >
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <p className="text-base-200 text-sm">Ens agrada rebre missatges pràctics: afegeix captures o fotos quan sigui possible perquè puguem ajudar millor.</p>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-base-800 border border-base-700 p-4 text-white focus:border-tech-accent focus:outline-none transition-colors placeholder-base-600"
                                        placeholder="Enllaç, pregunta o idea..."
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Explica breument la teva idea o problema. Si tens captures, inclou-les per facilitar la resposta."
                                    ></textarea>
                                </div>
