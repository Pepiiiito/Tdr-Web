                    ...
                    <div className="mt-24 space-y-32 md:space-y-48">
                        ...
                        <Section title="Procés de Desenvolupament" icon={Lightbulb} delay={0.2}>
                            ...
                            <div className="mt-8 space-y-6">
                                ...
                                {/* Incident Note */}
                                <div className="bg-base-700/10 p-6 border-l-2 border-status-warning rounded-sm">
                                    <h4 className="text-white font-bold mb-2">Nota d'incident (pre-entrega)</h4>
                                    <p className="text-sm text-base-200">
                                        El dia abans de la lliurament vaig connectar, per error, els cables del variador a la bateria invertits, provocant un curt circuit. Com a conseqüència, vaig haver d'adquirir un motor de major potència i vaig adaptar la <strong className="text-white">V1</strong> perquè fos compatible amb el xassís inicial. Aquesta adaptació va resoldre diversos problemes pràctics: el pinyó no lliscava gràcies a un eix més gros i el conjunt va guanyar en fiabilitat i facilitat de funcionament.
                                    </p>
                                </div>
                                <div className="flex gap-4">
