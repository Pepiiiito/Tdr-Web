                                ...
                                >
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="p-6 border-l-4 border-gray-600 bg-gray-600/5 rounded-sm">
                                            ...
                                            <p className="mt-2 text-sm text-base-200"><strong>Nota:</strong> El dia abans d'una entrega es va produir un incident: una connexió invertida entre el variador i la bateria va provocar un curt circuit, fet que va requerir l'adquisició d'un motor més potent i l'adaptació de la V1 per fer-la compatible amb el xassís inicial. L'eix més gros del nou motor també va ajudar a evitar el deslliscament del pinyó, millorant la fiabilitat.</p>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
